...
assert_contains '`docs/tasks/completed/`' "$empty_repo/AGENTS.md"
assert_contains 'Chỉ khi cần lịch sử liên quan' "$empty_repo/AGENTS.md"
...
assert_contains '## Ghi nhận friction' "$empty_repo/AGENTS.md"
assert_contains '`docs/friction/<yyyy-mm-dd>-<short-name>.md`' "$empty_repo/AGENTS.md"
assert_contains '### Mô tả cụ thể vấn đề' "$empty_repo/AGENTS.md"
assert_contains '`Impact`' "$empty_repo/AGENTS.md"
assert_contains '`Evidence`' "$empty_repo/AGENTS.md"
assert_contains 'Ghi lại friction đáng kể tại' "$empty_repo/AGENTS.md"
assert_contains 'không sao chép nội dung friction.' "$empty_repo/AGENTS.md"
assert_contains 'Không tạo plan chỉ để ghi' "$empty_repo/AGENTS.md"
assert_contains 'không mặc định là defect, debt' "$empty_repo/AGENTS.md"
assert_contains 'không tạo mục, thư mục hoặc file rỗng' "$empty_repo/AGENTS.md"
...
assert_contains '→ final outcome' "$empty_repo/AGENTS.md"
assert_contains '→ dùng `mv` chuyển sang docs/tasks/completed/' "$empty_repo/AGENTS.md"
